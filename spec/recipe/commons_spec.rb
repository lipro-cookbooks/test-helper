...
#
shared_examples 'commons_recipes' do |platform, version|
...
#
shared_examples 'commons_unsupported' do |platform, version|
...
# platform overrun
#
describe 'test-helper::commons' do
  # Test on all supported platforms
  supported_platforms.each do |platform, versions|
    versions.each do |version|
      include_examples 'commons_recipes', platform, version
    end
  end
  ...
  unsupported_platforms.each do |platform, versions|
    versions.each do |version|
      include_examples 'commons_unsupported', platform, version
    end
  end
end
