...
#
shared_examples 'default_recipes' do |platform, version|
...
#
shared_examples 'default_unsupported' do |platform, version|
...
# platform overrun
#
describe 'test-helper::default' do
  # Test on all supported platforms
  supported_platforms.each do |platform, versions|
    versions.each do |version|
      include_examples 'default_recipes', platform, version
    end
  end
  ...
  unsupported_platforms.each do |platform, versions|
    versions.each do |version|
      include_examples 'default_unsupported', platform, version
    end
  end
end
